        ...
        <main className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-12 py-8 sm:py-12">
          <header className="mb-10 sm:mb-12">
            ...
            <p className="mt-4 text-ink-700 leading-relaxed text-base sm:text-lg max-w-prose">
              What it is, how it's organized, and how to actually use it well.
            </p>
          </header>
          ...
          <footer className="mt-16 pt-8 border-t border-ink-100 text-[13px] text-ink-500 leading-relaxed">
            Source: <code className="font-mono break-all">~/Desktop/claude-code-features-nov2025-may2026.md</code>. Edit content in <code className="font-mono">lib/content.ts</code>.
          </footer>
        </main>
      </div>
    </div>
